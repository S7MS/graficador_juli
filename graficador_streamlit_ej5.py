...
st.title("Graficador de Fronteras de Utilidad (Streamlit)")

st.markdown("""
Permite ingresar parámetros, elegir función de utilidad y ver los gráficos de fronteras y óptimos.
""")
